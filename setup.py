...
RESOLVER_NAME = 'sceptre-secretsmanager-resolver'
# the resolver call in sceptre e.g. !command_name.
RESOLVER_COMMAND_NAME = 'secretsmanager'
...
RESOLVER_CLASS = 'SecretsManagerResolver'
...
RESOLVER_AUTHOR_EMAIL = 'me@haseeb.co'
RESOLVER_URL = 'https://github.com/haseebr/{}'.format(RESOLVER_NAME)
